...
class NairaCard extends StatelessWidget {
  const NairaCard({Key? key}) : super(key: key);
          ...
          Row(
            children: [
              MaterialButton(
                ...
                child: Text("Withdraw", style: Fonts.FONT_TEXT_BUTTONS),
              ),
              ...
              MaterialButton(
                ...
                shape: const RoundedRectangleBorder(
                    ...
                    borderRadius: BorderRadius.all(Radius.circular(8))),
                child: Text("Fund", style: Fonts.FONT_TEXT_BUTTONS_BLUE),
              ),
            ],
          )
        ],
